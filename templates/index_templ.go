...
(function () {
  ...
  function sortAlpha() {
    ...
    if (activeCategory === 'all') {
      open.sort(function (a, b) {
        var ga = GROUP_ORDER[a.dataset.category] !== undefined ? GROUP_ORDER[a.dataset.category] : 3;
        var gb = GROUP_ORDER[b.dataset.category] !== undefined ? GROUP_ORDER[b.dataset.category] : 3;
  ...
  function _doApplyFilter() {
    ...
    if (activeFilter === 'now') {
      label += ' free today';
      if (visible === 0) label = 'No ' + nounPl + ' free right now. Try "All" or another filter.';
